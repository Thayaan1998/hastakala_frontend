...
import 'package:fyp/customer/viewOrderedItem.dart';


class GetNormalOrders extends StatefulWidget {
  const GetNormalOrders({Key? key}) : super(key: key);

  @override
  GetNormalOrdersState createState() {
    return GetNormalOrdersState();
  }
}

class GetNormalOrdersState extends State<GetNormalOrders> {
  ...
  loadOrderDetails() async {
    ...
    final response = await http.post(
      Uri.parse(Config.mainUrl + '/getOrdersByCustomerId'),
