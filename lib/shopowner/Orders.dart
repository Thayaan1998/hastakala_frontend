...
import 'package:fyp/shopowner/getNormalItemsToAcceptOrReject.dart';
  ...
  void initState() {
    ...
    _loadDatas() async {
      var response2 = await http.post(
        Uri.parse(Config.mainUrl + '/getOrders'),
          ...
          child: _isLoading
            ...
            onEventSelected: (event){
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                    const GetNormalItemsToAcceptOrReject()),
              ).then((value) async {
                setState(()  {
                  events= {};
